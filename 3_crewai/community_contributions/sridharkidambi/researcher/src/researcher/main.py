...
def run():
    ...
    """
    inputs = {
        'topic': 'list all the most popular adopted agentic AI framework in 2026 and their features and compare them with each other. Also how the 2027 will be different from 2026 in terms of AI framework and their features',
